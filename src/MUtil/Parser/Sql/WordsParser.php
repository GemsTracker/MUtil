...
class WordsParser
{
    ...
    private function findCharEnd($pos, $char, $startLine = 0, $startPos = 0)
    {
        ...
        if ($pos >= $this->_len) {
            throw new \MUtil\Parser\Sql\WordsParserException('Opening '.$char.' does not close', $startLine, $startPos);
        }
    ...
    private function findCharsEnd($pos, $chars, $startLine = 0, $startPos = 0)
    {
        ...
        if ($pos >= $this->_len) {
            throw new \MUtil\Parser\Sql\WordsParserException('Opening '.$chars.' does not close', $startLine, $startPos);
        }
